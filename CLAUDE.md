...
**These guidelines are working if:** fewer unnecessary changes in diffs, fewer rewrites due to misdirection or overcomplication, clarifying questions come before implementation rather than after mistakes, and wrong or ill-informed information is flagged before it causes damage.
